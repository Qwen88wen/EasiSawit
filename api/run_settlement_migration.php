<?php
// Run worker settlement migration

include 'db_connect.php';

echo "Running worker settlement migration...\n\n";

// Create worker_settlements table
$sql1 = "CREATE TABLE IF NOT EXISTS worker_settlements (
...
if ($conn->query($sql1)) {
    echo "✓ Table 'worker_settlements' created successfully\n";
} else {
    echo "✗ Error creating worker_settlements: " . $conn->error . "\n";
}

// Create settlement_work_logs table
$sql2 = "CREATE TABLE IF NOT EXISTS settlement_work_logs (
    id INT AUTO_INCREMENT PRIMARY KEY,
...
if ($conn->query($sql2)) {
    echo "✓ Table 'settlement_work_logs' created successfully\n";
} else {
    echo "✗ Error creating settlement_work_logs: " . $conn->error . "\n";
}
